---
title: Davas Core Experience
status: active
role: product-source-of-truth
created: 2026-07-12
last-verified: 2026-07-25
applies-to: Next.js mobile web + NestJS API
---

# Davas 핵심 경험 전면 재설계안

> **Authority:** 제품 범위, IA, UX, 데이터·API 계약의 단일 기준 문서다. 실제 구현 사실은 코드와 migration이 최종 권위이며, 완료 판정은 [`../verification/quality-gates.md`](../verification/quality-gates.md)의 증거가 있을 때만 내린다.

- 문서 상태: Active / 구현 가능 설계 확정안
- 작성일: 2026-07-12
- 최종 현행 검토: 2026-07-25
