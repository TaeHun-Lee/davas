...
Cohesion: 0.07
Nodes (28): TaskShell(), LegalScreen(), legalDocuments, CURRENT_PRIVACY_VERSION, CURRENT_TERMS_VERSION, DAVAS_APP_NAME, DIARY_VISIBILITIES, FRIENDSHIP_STATUSES (+20 more)

### Community 6 - "GenreRecommendationSection.tsx"
Cohesion: 0.13
Nodes (15): GenreRecommendationSection(), GenreRecommendationSectionProps, GenreRecommendationTile, placeholderGenreTiles, CalendarDayStateInput, cn(), getCalendarDayState(), MonthlyWatchCalendarSection() (+7 more)
...
Cohesion: 0.16
Nodes (13): getDepartmentLabel(), PersonSearchResults(), PeopleSearchStatus, PersonCreditsStatus, usePeopleSearch(), getPersonCredits(), MediaSearchResponse, MyMediaDiary (+5 more)

### Community 15 - "recommendations.ts"
Cohesion: 0.12
Nodes (25): ExploreRecommendationsState, GenreRecommendationTile, initialState, RecommendationStatus, RequestStatus, useGroupRecommendations(), createGroupRecommendationSession(), fetchRecommendation() (+17 more)
...
Cohesion: 0.10
Nodes (19): ActivityIconName, ProfileActivitySection(), ProfileActivitySectionProps, buildProfileView(), buildRecentListCard(), ProfileDashboard(), ProfileListCard, ProfileMetric (+11 more)
...
Cohesion: 0.07
Nodes (29): CoreAppShell(), MediaTypeControl(), RecordCard(), SearchField(), tabs, ViewingMethodControl(), FeedScreen(), MineScreen() (+21 more)
...
### Community 186 - "UserConsentEntity"
Cohesion: 0.25
...
### Community 204 - "5. 필요한 데이터"
Cohesion: 0.50
Nodes (4): 5. 필요한 데이터, 명시적 신호, 암시적 신호, 콘텐츠 특징

### Community 205 - "8. 추천 파이프라인"
Cohesion: 0.50
Nodes (4): 8. 추천 파이프라인, 단계 1: 요청 정규화, 단계 2: 하드 필터, 단계 3: 후보 생성

### Community 207 - "16. 평가 지표"
Cohesion: 0.67
Nodes (3): 16. 평가 지표, 오프라인, 온라인

## Knowledge Gaps
- **571 isolated node(s):** `$schema`, `collection`, `sourceRoot`, `deleteOutDir`, `name` (+566 more)
