...
## Corpus Check
- 382 files · ~116,801 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2821 nodes · 5552 edges · 196 communities (168 shown, 28 thin omitted)
...
### Community 5 - "watch-events.ts"
Cohesion: 0.12
Nodes (28): participantLabels, safeReturn(), sourceLabels, WatchEventDetailScreen(), SpaceTimeline(), getRecord(), compareSpaceReactions(), deleteWatchEvent() (+20 more)
...
Cohesion: 0.07
Nodes (25): LegalScreen(), legalDocuments, CURRENT_PRIVACY_VERSION, CURRENT_TERMS_VERSION, DAVAS_APP_NAME, DIARY_VISIBILITIES, FRIENDSHIP_STATUSES, FriendshipStatus (+17 more)
...
Cohesion: 0.06
Nodes (31): FakeUserRepository, CommunityCommentView, FakeCommentsRepository, NotificationEntity, Column, CreateDateColumn, Entity, Index (+23 more)
...
Cohesion: 0.15
Nodes (12): Poster(), Draft, freshDraft(), RecordComposer(), sourceLabels, today(), WATCH_RATINGS, WatchRatingControl() (+4 more)
...
Cohesion: 0.22
Nodes (19): FriendInviteScreen(), empty, FriendsScreen(), getApiBaseUrl(), acceptFriend(), acceptFriendInvite(), cancelFriend(), createFriendInvite() (+11 more)
...
### Community 42 - "ExploreDashboard.tsx"
Cohesion: 0.16
...
Cohesion: 0.07
Nodes (25): Column, Entity, Index, JoinColumn, ManyToOne, PrimaryGeneratedColumn, WatchShareEntity, DiaryListQuery (+17 more)
...
Cohesion: 0.12
Nodes (17): 10. 성공 지표, 11. 분석 이벤트 최소 집합, 12. 주요 위험과 대응, 13. 출시 전 확정할 결정, 1. 목적과 범위, 2. 제품 원칙, 4.1 공간 시작, 4.2 감상 기록 (+9 more)
...
Cohesion: 0.11
Nodes (10): Optional, buildContentPreview(), FavoriteMediaItem, FavoriteMediaResponse, formatWatchedDate(), MediaDetailResponse, MediaFavoriteResponse, MediaService (+2 more)
...
Cohesion: 0.15
Nodes (21): AuthenticatedLanding(), MeResponse, buildCalendarDays(), buildHomeDashboardView(), formatRating(), getMediaMeta(), getPrimaryGenre(), HomeDashboard() (+13 more)
...
Cohesion: 0.08
Nodes (31): AsyncState(), CoreAppShell(), EmptyState(), MediaTypeControl(), RecordCard(), SearchField(), tabs, TaskShell() (+23 more)
...
### Community 139 - "group-recommendation-model.ts"
Cohesion: 0.17
...
### Community 140 - "HomeStatsGrid.tsx"
Cohesion: 0.20
...
### Community 143 - "DiaryInsightGrid.tsx"
Cohesion: 0.18
...
### Community 156 - "DiarySummarySection.tsx"
Cohesion: 0.22
...
### Community 160 - "InviteCodeEntity"
Cohesion: 0.18
...
### Community 164 - "diaries.ts"
Cohesion: 0.22
Nodes (8): DiaryDashboardView, CreatedDiaryResponse, createDiary(), CreateDiaryPayload, deleteDiary(), EditableDiary, getDiary(), updateDiary()
...
### Community 171 - "diary-dashboard-types.ts"
Cohesion: 0.33
...
### Community 173 - "NotificationPreferenceEntity"
Cohesion: 0.17
...
### Community 193 - "3. 사용자와 관계 모델"
Cohesion: 0.50
Nodes (4): 3. 사용자와 관계 모델, 감상 참여자, 공유 공간, 사용자

### Community 195 - "7. 비기능 요구사항"
Cohesion: 0.50
Nodes (4): 7. 비기능 요구사항, 보안과 개인정보, 성능과 접근성, 신뢰성

## Knowledge Gaps
- **554 isolated node(s):** `$schema`, `collection`, `sourceRoot`, `deleteOutDir`, `name` (+549 more)
...
- **Why does `DiaryEntity` connect `DiaryEntity` to `DiariesService`, `diaries.dashboard.spec.ts`, `diaries-dashboard.service.ts`, `DiaryLikeEntity`, `WatchSourceEntity`, `DiariesDashboardService`, `typeorm.config.ts`, `community.service.ts`, `UserEntity`, `media.service.ts`, `WatchEventsService`, `diaries.module.ts`, `DiaryShareEntity`, `watch-events.service.ts`, `CommentEntity`, `MediaEntity`, `WatchReactionEntity`, `group-recommendations.service.ts`?**
