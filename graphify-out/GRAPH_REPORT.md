...
## Corpus Check
- 394 files · ~121,681 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2896 nodes · 5579 edges · 217 communities (178 shown, 39 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 14 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f26f57cd`
...
1. `UserEntity` - 86 edges
2. `DiaryEntity` - 77 edges
3. `AuthService` - 55 edges
4. `getApiBaseUrl()` - 54 edges
5. `MediaEntity` - 52 edges
6. `WatchEventsService` - 30 edges
7. `coreFetch()` - 27 edges
...
- `RecordComposer()` --calls--> `getMediaDetail()`  [EXTRACTED]
  apps/web/src/components/core/RecordComposer.tsx → apps/web/src/lib/api/media.ts
- `compareSpaceReactions()` --calls--> `coreFetch()`  [EXTRACTED]
  apps/web/src/lib/api/watch-events.ts → apps/web/src/lib/api/core.ts
- `createWatchEvent()` --calls--> `coreFetch()`  [EXTRACTED]
  apps/web/src/lib/api/watch-events.ts → apps/web/src/lib/api/core.ts
...
Cohesion: 0.07
Nodes (36): SpaceTimeline(), getSpaceTimeline(), WatchEvent, WatchParticipant, WatchReaction, WatchSource, DAVAS_APP_NAME, DIARY_VISIBILITIES (+28 more)
...
Cohesion: 0.08
Nodes (22): InjectRepository, Optional, DiaryShareEntity, Column, Entity, Index, JoinColumn, ManyToOne (+14 more)
...
Cohesion: 0.14
Nodes (16): getDepartmentLabel(), PersonSearchResults(), useMediaSearch(), PeopleSearchStatus, PersonCreditsStatus, usePeopleSearch(), getPersonCredits(), MediaSearchResponse (+8 more)
...
### Community 16 - "diary.entity.ts"
Cohesion: 0.10
Nodes (19): CommunityCommentView, FakeCommentsRepository, CommentEntity, Column, CreateDateColumn, DeleteDateColumn, Entity, Index (+11 more)
...
### Community 19 - "TodayRecommendationSection.tsx"
Cohesion: 0.15
Nodes (12): DiarySummary, DiarySummaryCard(), DiarySummaryCardProps, toneClasses, DiarySummarySection(), DiarySummarySectionProps, buildTodayHeroItems(), getRecommendationMeta() (+4 more)
...
### Community 35 - "DiaryEntity"
Cohesion: 0.05
Nodes (41): DiaryEntity, Column, CreateDateColumn, DeleteDateColumn, Entity, Index, JoinColumn, ManyToOne (+33 more)
...
Cohesion: 0.15
Nodes (13): ExploreDashboard(), recommendationToPosterItem(), ExploreFilter, ExploreFilterChips(), filters, ExploreShortcutGrid(), FavoriteMovie, FavoriteMoviesSection() (+5 more)
...
Cohesion: 0.16
Nodes (17): participantLabels, safeReturn(), sourceLabels, WatchEventDetailScreen(), WATCH_RATINGS, WatchRatingControl(), getRecord(), compareSpaceReactions() (+9 more)
...
Cohesion: 0.14
Nodes (23): assignCandidateChannels(), calculateGroupBase(), CandidateAvailability, clamp01(), DEFAULT_GROUP_GAMMA, DEFAULT_GROUP_LAMBDA, diversityRerank(), GROUP_RECOMMENDATION_ALGORITHM_VERSION (+15 more)
...
### Community 63 - "group-recommendation-model.ts"
Cohesion: 0.19
...
Cohesion: 0.20
Nodes (6): RankedCandidate, RatingSignal, GroupRecommendationsService, normalized(), response(), Injectable

### Community 73 - "entities/index.ts"
Cohesion: 0.12
Nodes (14): DiaryLikeEntity, Column, CreateDateColumn, Entity, Index, JoinColumn, ManyToOne, PrimaryGeneratedColumn (+6 more)
...
Cohesion: 0.16
Nodes (7): buildContentPreview(), formatWatchedDate(), MediaService, Injectable, InjectRepository, Optional, Inject
...
Cohesion: 0.09
Nodes (22): BasicInfoGrid(), DetailInfoCard(), FriendRecordsCard(), FriendRecordsStatus, MyRatingCard(), StillCutStrip(), fallbackOverview(), MediaDetailModal() (+14 more)
...
### Community 99 - "watch-events.service.ts"
Cohesion: 0.17
Nodes (23): CreateWatchEventDto, SaveWatchReactionDto, ArrayMaxSize, ArrayUnique, IsArray, IsIn, IsInt, IsOptional (+15 more)

### Community 100 - "FriendInvitesService"
Cohesion: 0.30
Nodes (4): error(), FriendInvitesService, hashToken(), Injectable

### Community 105 - "DiaryReactionEntity"
Cohesion: 0.18
...
Cohesion: 0.10
Nodes (20): AvailabilityObservationEntity, Column, CreateDateColumn, Entity, Index, JoinColumn, ManyToOne, PrimaryGeneratedColumn (+12 more)
...
### Community 140 - "WatchEventsController"
Cohesion: 0.22
...
### Community 143 - "SpaceWatchController"
Cohesion: 0.29
...
### Community 148 - "diaries.controller.ts"
Cohesion: 0.11
Nodes (15): media, payload, AuthenticatedRequest, DiaryListQuery, IsBoolean, IsIn, IsInt, IsOptional (+7 more)
...
### Community 153 - "HomeStatsGrid.tsx"
Cohesion: 0.20
...
Cohesion: 0.15
Nodes (11): HomeRecommendations(), RecommendationStatus, recommendationTabs, RecommendationType, GenreRecommendationSection(), GenreRecommendationSectionProps, GenreRecommendationTile, placeholderGenreTiles (+3 more)
...
### Community 165 - "PersonCreditResults.tsx"
Cohesion: 0.19
Nodes (9): getTmdbGenreNames(), TMDB_MOVIE_GENRES, TMDB_TV_GENRES, MediaDetailLoadingIndicator(), MediaDetailLoadingIndicatorProps, MediaSearchResults(), formatCreditMeta(), PersonCreditResults() (+1 more)

### Community 166 - "4. 핵심 사용자 흐름"
Cohesion: 0.40
...
Cohesion: 0.05
Nodes (26): FakeUserRepository, InjectRepository, Optional, FriendshipEntity, Column, CreateDateColumn, Entity, Index (+18 more)
...
### Community 208 - "13. 테스트 전략"
Cohesion: 0.50
Nodes (4): 13. 테스트 전략, 도메인 단위 테스트, 종단 간 테스트, 통합 테스트

## Knowledge Gaps
- **589 isolated node(s):** `serviceSource`, `queryDtoSource`, `DiaryListQuery`, `MyMediaDiary`, `MediaDetailResponse` (+584 more)
...
- `RecordComposer()` (3× useful, score=2.889115873)
- `RecordScreens.tsx` (3× useful, score=2.842083673)
- `WatchEventsService` (3× useful, score=2.827389181)
- `layout.tsx` (2× useful, score=1.900852266)
- `PwaStatus.tsx` (2× useful, score=1.900852266)
- `PwaStatus()` (2× useful, score=1.900852266)
- `SpaceMembershipEntity` (2× useful, score=1.892923554)
- `typeorm.config.ts` (2× useful, score=1.887364622)
- `GroupRecommendationSessionRequest` (2× useful, score=1.887098594)
- `api/package.json` (2× useful, score=1.70022834)
...
- **Why does `DiaryEntity` connect `DiaryEntity` to `community.service.ts`, `DiaryAccessService`, `reactions.service.ts`, `diaries.module.ts`, `diary.entity.ts`, `diaries.controller.ts`, `NotificationEntity`, `SpaceMembershipEntity`, `RecommendationExposureEntity`, `diaries-dashboard.service.ts`, `DiariesDashboardService`, `typeorm.config.ts`, `media.service.ts`, `WatchEventsService`, `MediaEntity`, `UserEntity`, `group-recommendations.service.ts`, `diaries.dashboard.spec.ts`, `entities/index.ts`, `watch-events.service.ts`, `DiaryReactionEntity`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **What connects `serviceSource`, `queryDtoSource`, `DiaryListQuery` to the rest of the system?**
