  ...
  return (
    <AppShell>
      <section className="pb-8" data-design="profile-support-screen">
        <Link href="/profile" className="inline-flex min-h-11 items-center text-[13px] font-black text-[#216bd8]">← 프로필</Link><h1 className="py-3 text-[22px] font-black text-[#23426f]">고객센터</h1>
