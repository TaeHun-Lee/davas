  ...
  switch (name) {
    case 'clapper':
      return (
        <svg {...common}>
          ...
          <path
            d="M4 8l15-3 1 3M7 7.4l2.1-2.7M12 6.4l2-2.7M16.7 5.4l1.9-2.3"
            stroke="#6f84a3"
            strokeWidth="1.6"
            strokeLinecap="round"
          />
    ...
    case 'eye':
      return (
        <svg {...common}>
          <path
            d="M3 12s3.4-5.2 9-5.2S21 12 21 12s-3.4 5.2-9 5.2S3 12 3 12Z"
            stroke="#6f84a3"
            strokeWidth="1.8"
          />
    ...
    case 'pen':
      return (
        <svg {...common}>
          <path
            d="M5 18.5 6.2 14 15.6 4.6a2 2 0 0 1 2.8 2.8L9 16.8 5 18.5Z"
            stroke="#6f84a3"
            strokeWidth="1.8"
            strokeLinejoin="round"
          />
          <path
            d="M13.8 6.4 16.6 9.2M5 20h14"
            stroke="#6f84a3"
            strokeWidth="1.7"
            strokeLinecap="round"
          />
    ...
    case 'heart':
      return (
        <svg {...common}>
          <path
            d="M12 19.3S4.5 15 4.5 9.3A3.8 3.8 0 0 1 11.3 7 3.8 3.8 0 0 1 18 9.3C18 15 12 19.3 12 19.3Z"
            stroke="#6f84a3"
            strokeWidth="1.8"
            strokeLinejoin="round"
          />
      ...
      <div className="card-surface grid grid-cols-4 divide-x divide-[#e7edf5] rounded-[20px] bg-white px-2 py-4 shadow-[0_12px_28px_rgba(31,65,114,0.08)]">
        {activityItems.map((item) => (
          <div key={item.label} className="flex min-w-0 flex-col items-center px-1 text-center">
            ...
            <p className="mt-1 text-[18px] font-black leading-[22px] text-[#2a4a7d]">
              {item.value ?? item.unavailableLabel}
            </p>
          </div>
        ))}
      </div>
