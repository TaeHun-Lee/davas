...
export function AuthenticatedLanding() {
  ...
  if (loadError) {
    return (
      <AppShell>
        <section className="rounded-[24px] bg-white p-8 text-center shadow-[0_14px_30px_rgba(31,65,114,0.08)]">
          <h1 className="text-[18px] font-black text-[#23426f]">홈을 불러오지 못했어요</h1>
          <p className="mt-2 text-[13px] font-bold text-[#65758a]">
            로그인 상태는 유지돼요. 네트워크를 확인하고 다시 시도해 주세요.
          </p>
          <button
            type="button"
