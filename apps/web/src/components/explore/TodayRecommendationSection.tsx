...
function TodayRecommendationPlaceholder() {
  return (
    <div
      data-design="today-recommendation-placeholder"
      aria-label="오늘의 추천을 불러오는 중"
      className="grid grid-cols-2 items-stretch gap-3 max-[430px]:grid-cols-1 max-[430px]:gap-4"
    >
      <div
        data-design="recommendation-still-placeholder"
      ...
      <div
        className="flex min-w-0 flex-col justify-center py-1 max-[430px]:py-0"
        aria-hidden="true"
      >
