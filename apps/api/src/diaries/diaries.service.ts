...
export class DiariesService {
  ...
  private applyFilters(
    ...
    if (query.viewingMethod)
      qb.andWhere('diary.viewingMethod = :viewingMethod', { viewingMethod: query.viewingMethod });
  }
  ...
  private applyCursor(
    ...
    try {
      ...
      qb.andWhere(
        ...
        { cursorFirst: cursor.first, cursorCreated: cursor.createdAt, cursorId: cursor.id },
      );
    } catch {
